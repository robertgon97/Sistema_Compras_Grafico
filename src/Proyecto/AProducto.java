...
public class AProducto extends javax.swing.JFrame {
    ...
    public static Venta sp;
    
    public static Inventario st;
   
    public AProducto(int i,Venta s,Inventario sc) {
        ddi = i;
        sp = s;
        st = sc;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Proyecto/niBjnL9iA.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(new ActualizarInventario().add(jTextField1.getText(),Integer.parseInt(jTextField2.getText()),Float.parseFloat(jTextField3.getText()),jTextField4.getText(),jTextField5.getText(),jTextField6.getText(),jTextField7.getText(),ddi)){
...
//            getToolkit().beep();
//            evt.consume(); // Detengo la Letra
//            JOptionPane.showMessageDialog(null,"Sólo se permite un punto", "Error de Escritura",JOptionPane.ERROR_MESSAGE);
//        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AProducto(ddi,sp,st).setVisible(true);
            }
        });
    }
